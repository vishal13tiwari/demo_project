...
<div id="flipkart-navbar">
    <div class="container">
        ...
        <div class="row row2">
            <div class="col-sm-2">
                <h1 style="margin:0px;"><span class="largenav">Article</span></h1>
            </div>
	    ...
	    <div class="row col-md-12 custyle">
		    ...
		    <thead>
		    <a href="user_homepage_add.php" class="btn-xs pull-right">
		    	...
		    	while ($row=mysqli_fetch_assoc($result)) { ?>
		            <tr>
		                ...
		                <td class="text-center">
		                	<a href="user_homepage_add.php?id_user=<?php echo $row['id_user'] ?>">
		                		<button type="submit" class="btn btn-primary">
		                			<span class="glyphicon glyphicon-edit"></span>Edit
		                		</button>
		                	</a>
		                	<a href="user_homepage.php?id_user=<?php echo $row['id_user'] ?>">
